...
<head>
  ...
  <title>Halaman Penjual - | Pemasukan</title>
  ...
  <link rel="stylesheet" href="{{asset('css/csspemasukan.css')}}">
  <!-- overlayScrollbars -->
...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
     ...
     <!-- SEARCH FORM -->
    <form class="form-inline ml-3" method="get" action="/penjual/pemasukan/cari" enctype="multipart/form-data">
        <div class="input-group input-group-sm">
          <input type placeholder="Masukkan Tanggal Pencarian" class="textbox-n" type="text" onfocus="(this.type='date')" id="date" name="date" class="form-control datepicker">
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item">
        <a class="nav-link" href="/penjual/logout" role="button" onclick="return confirm('Ingin Log Out ?')">
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <!-- Data Pemasukan -->
          <li class="nav-item">
            <a href="/penjual/pemasukan" class="nav-link active">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="/penjual">Home</a></li>
     ...
     <section class="content">
        <div class="container-fluid">
            ...
            @if ($message = Session::get('success'))
                ...
                @endif
                <a href="/penjual/pemasukan/cetak" class="btn btn-primary">Cetak Pemasukan</a>
        </br></br>
          ...
          <div class="card-body">
                  <table>
                    ...
                    @foreach($pemasukan as $ang)
                      ...
                      <td>
                        <a href="/penjual/pemasukan/edit/{{ $ang->id }}" class="btn btn-warning" style="width:100%;">Ubah Status Pemasukan</a></br></br>
                        <a href="/penjual/pemasukan/hapus/{{ $ang->id }}" class="btn btn-danger" style="width:100%;">Hapus</a>
                      </td>
                      </tr>
                      @endforeach
                    </tbody>
