...
<head>
  ...
  <title>Halaman Penjual - | Stok Ikan</title>
  ...
  <link rel="stylesheet" href="{{asset('css/cssstokikan.css')}}">
  <!-- overlayScrollbars -->
...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
     ...
     <!-- SEARCH FORM -->
   <form class="form-inline ml-3" method="get" action="/penjual/ikan/cari">
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <!-- Data Ikan -->
          <li class="nav-item">
            <a href="/penjual/ikan" class="nav-link active">
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0" >Stok Ikan</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="/penjual">Home</a></li>
              <li class="breadcrumb-item active">Data Stok Ikan</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    ...
    <!-- /.content-header -->
     ...
     <section class="content">
        ...
        <a href="/penjual/ikan/tambah" class="btn btn-primary">Input Data Stok Ikan</a>
        </br></br>
        <div class="card">
          <div class="card-body">
                  <table>
                    ...
                    <tbody>
                    @foreach($stokikan as $ang)
                      <tr>
                      <td>{{ $loop->iteration }}</td>
                      <td>{{ $ang->jenis_ikan }}</td>
                      <td>{{ $ang->jumlah_ikan }}</td>
                      <td>{{ $ang->harga_satuan }}</td>
                      <td>{{ $ang->created_at }}</td>
                      <td>
                        <a href="/penjual/ikan/edit/{{ $ang->id }}" class="btn btn-warning" style="width:100%;">Edit</a></br></br>
                        <a href="/penjual/ikan/hapus/{{ $ang->id }}" class="btn btn-danger" style="width:100%;">Hapus</a>
                      </td>
                      </tr>
                      @endforeach
                    </tbody>
