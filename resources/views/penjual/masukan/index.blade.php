...
<head>
  ...
  <title>Halaman Penjual - | Masukan Dan Saran</title>
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <!-- Data Masukan -->
            <li class="nav-item">
            <a href="/penjual/masukan" class="nav-link active">
            <i class="fas fa-solid fa-credit-card nav-icon"></i>
            <p>
                Saran Dan Masukan
            </p>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Data Saran Dan Masukan</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
          ...
          <div class="card-body">
                  <table>
                    ...
                    @foreach($masukan as $ang)
                      ...
                      <td>{{ $ang->message }}</td>
                      <td>
                        <a href="/penjual/masukan/hapus/{{ $ang->id }}" class="btn btn-danger" style="width:100%;">Hapus</a>
                      </td>
                      </tr>
                      @endforeach
                    </tbody>
