...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Register Penjual') }}</div>

                <div class="card-body">
                    <form method="POST" action="{{ route('penjual.register.submit') }}">
                        @csrf
                        ...
                        <div class="form-group row">
                            <label for="no_telp" class="col-md-4 col-form-label text-md-right">{{ __('Nomor Telpon') }}</label>
