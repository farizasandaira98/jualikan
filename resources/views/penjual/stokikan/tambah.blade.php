    ...
    <div class="container">
        <div class="card mt-5">
            <div class="card-header text-center">
                DATA STOK IKAN - <strong>TAMBAH DATA</strong>
            </div>
            <div class="card-body">
                ...
                <form method="post" action="/penjual/ikan/store">
                    {{ csrf_field() }}
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="jumlah_ikan" class="form-control" placeholder="Jumlah Ikan ..">
...
var msg  = "TAMBAH DATA STOK IKAN - PASAR ONLINE IKAN ";
var res = " ";
var speed = 100;
var pos = val;
var le = msg.length;
